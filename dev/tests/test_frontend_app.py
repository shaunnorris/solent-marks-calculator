...
def test_calculate_button_positioned_right_of_course_list(client):
    ...
    # Accept either button text or button ID
    assert 'Calculate' in html and 'Course Legs' in html or 'id="calculateCourseBtn"' in html
    ...
    calculate_index = html.find('Calculate')
